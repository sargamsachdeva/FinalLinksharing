...
class UserController {
    ...
    def index(SearchCO searchCO) {
        ...
        render(view: 'index', model: [subscribedTopics : session.user.subscribedTopics,
                                      ...
                                      subscriptions    : DomainToVO.userSubscriptions(session.user,searchCO),
                                      searchCO         : searchCO,
                                      totalSubscriptions:session.user.getTotalSubscriptions(),
                ...
                if(invitation.validate()){
                    ...
                    runAsync {
                        mailService.sendMail {
                            ...
                            text "hii This is a invite for u.." + "\n" + text1
                        }
                    }
    ...
    def tryingUnreadItems(){

        render template: '/mailTemplates/unreadPanel',model: [unreadResources:DomainToVO.getUnreadreadingItems(session.user)]
    }
}
