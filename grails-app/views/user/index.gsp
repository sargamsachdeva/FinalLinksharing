...
<div class="row" style="padding: 2px 15px ">
    ...
    <div class="col-md-5">
        ...
        <div class="row" style="margin-left: 10px">
            <div class="panel panel-default panel-primary panelTrendingTopics">
                ...
                <div>
                    ...
                    <g:paginate class="pagination" total="${totalSubscriptions}" controller="user" action="index"
        ...
        <br/>
        <div class="row" style="overflow-y:scroll; height:auto;max-height: 400px;margin-left: 10px">
