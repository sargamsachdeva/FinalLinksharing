<div class="panel-body">
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-6 topicShowPanel_${topic.id}">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="dropdown">
                <ls:canUpdateTopic>
                    <g:form controller="subscription" action="update" name="subscriptionSeriousnessForm">
                        <g:field type="hidden" name="topicId" value="${topic.id}"></g:field>
                        <ls:showSeriousness topicId="${topic.id}"  />
                    </g:form>

%{--
                    <g:select name="seriousness" id="seriousness-${topic.id}"
                              from="${seriousness}"
